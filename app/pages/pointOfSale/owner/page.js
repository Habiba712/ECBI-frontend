...
export default function PointOfSale() {
    ...
    return (
        <section className="mt-4 mx-auto max-w-5xl p-4 text-gray-500 w-full"
                ...
                pointsOfSaleByOwner && pointsOfSaleByOwner?.length > 0 ?
                    pointsOfSaleByOwner.map((item, index) => {
                        ...
                        return (
                            <div
                                key={index || item?._id}
                                className="mt-4 rounded-lg shadow-lg flex flex-col gap-5 justify-between item?s-start p-4 w-[100%] h-[100%]">
                                <div className="flex justify-between h-full w-full">
                                    <div className="h-full w-2/3 flex-grow">
                                        <img src={item?.coverImage} alt="restaurant" className="rounded-lg h-[300px] w-full object-cover aspect-square flex-grow" />
                                    </div>
                                    <div className=" w-1/3 grid grid-cols-2 gap-3 flex-grow ">
                                        ...
                                        <div className=" w-full">
                                            ...
                                            <div className="flex flex-col gap-2 mt-5 w-full">
                                                ...
                                                <div className="ml-4 font-semibold w-full flex gap-2"
                                                    style={{
                                                        fontSize: '13px',
                                                        fontWeigh: 'normal'
                                                    }}
                                                >
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        <p className="">{item?.address.zipCode}</p>
                                                    </div>


                                                </div>

                                                <div className="ml-4 text-sm  w-full flex items-center font-semibold gap-2"
                                                    style={{
                                                        fontSize: '13px',
                                                ...
                                                <div style={{
                                                    ...
                                                    Specialises in {item?.cuisine} cuisine</div>

                            ...
                            <div className="flex flex-col w-full">
                                ...
                                .map((notif) => (
                                    <div
                                        ...
                                        className={`flex items-start w-full rounded-lg  border-gray-50/80 bg-white shadow-lg   gap-3 py-3 px-1 cursor-pointer hover:bg-gray-50/50 transition-colors duration-150 mb-1 ${notif?.read == false && 'border-1 border-purple-300 shadow-hidden'}`
